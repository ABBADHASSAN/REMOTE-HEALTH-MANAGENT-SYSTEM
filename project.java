...
public class testapp {
    public static void main(String[] args) {
        ...
        System.out.println("Name: " + d.get_name() + "\n Breed: " + d.get_breed());
        d.speak();
    }
}
...
class employee extends person {
    ...
    private date date_hired;
         ...
         employee(String name, String address, String phone, String email,String office ,int salary , date date_hired){
        super(name, address, phone, email);
        this.office=office;
        this.salary=salary;
...
class faculty extends employee{
    private int office_hrs ;
    private String rank;
    faculty(String name, String address, String phone, String email,String office ,int salary,date date_hired,int office_hrs,String rank){
...
class staff extends employee{
 private String title;
  staff(String name, String address, String phone, String email,String office ,int salary,date date_hired,String title){
    super(name, address, phone, office,email,salary , date_hired);
    this.title=title;

     }
     @Override
     public String toString() {
        return "Staff: " + get_name();
    }
}
...
public class testapp{
    public static void main(String[] args) {
        person person = new person("zahid ali", "lahore", "569752", "jbc@gmail.com");


        student student = new student("hiader khan", "islamabad", "595263", "jbc@gmail.com", 2);


        date hireDate = new date(2020, 6, 15);

        employee e1 = new employee("imran abbas", "multan", "96245252","jbc@gmail.com", "B-101", 60000, hireDate);

        faculty f1 = new faculty("shahid imtiaz", "guranwala", "793153566", "jbc@gmail.com", "A-201", 80000,  new date(2015, 8, 1), 5, "Professor");


        staff staff = new staff("latif", "sukkhur", "4435636",  "jbc@gmail.com", "C-305", 50000,   new date(2018, 3, 10), "IT Support ");
